...
def get_commit_and_contrib_data(username, token, account_created_at):
    ...
    total_commits = 0
    contributed_repos = set()  # can't dedupe repo names from this query alone; see note below
...
def svg_overwrite(filename, age_data, repo_data, follower_data, star_data, commit_data, contrib_data):
...
if __name__ == "__main__":
    ...
    total_commits, contributed_repos_count = get_commit_and_contrib_data(username, token, created_at)
    ...
    svg_overwrite("darkmode.svg", age_data, repo_data, followers, star_count, total_commits, contributed_repos_count)
